...
Events:Subscribe('Level:LoadResources', function(p_LevelName, p_GameMode, p_IsDedicatedServer)
	...
	local s_LevelName = ServerUtils and ServerUtils:GetCustomMapName() or m_LevelNameMap[p_LevelName] or p_LevelName
	---@diagnostic disable-next-line: undefined-global
	local s_GameMode = ServerUtils and ServerUtils:GetCustomGameModeName() or m_GameModeNameMap[p_GameMode] or p_GameMode
