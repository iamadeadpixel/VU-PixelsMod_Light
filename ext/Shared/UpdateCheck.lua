do
	...
	local function _GetResponse()
		...
		local s_Response = Net:GetHTTP("https://raw.githubusercontent.com/spatieman/VU-PixelsMod_FlashHit/main/mod.json", s_Options);
	...
	if s_Version ~= m_ModVersion then
		print("*******************************************************************************************************");
		print("** Pixelmod light version seems to be out of date! Please visit https://raw.githubusercontent.com/spatieman/VU-PixelsMod_FlashHit/main/mod.json **");
